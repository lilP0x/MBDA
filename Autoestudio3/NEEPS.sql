...
CREATE TABLE EVENT(
    ...
    --FOREIGN KEY (modle_event) REFERENCES Modle(id_modle)
    /*FOREIGN KEY (room_event) REFERENCES room(id_room)*/
);

CREATE TABLE TEACHES(
    staff varchar(20) NOT NULL,
    event varchar(20) NOT NULL
    --CONSTRAINT PK_teaches PRIMARY KEY (staff_teaches, event_teaches) 
);

CREATE TABLE OCCURS(
    event varchar(20) NOT NULL,
    week varchar(20) NOT NULL
    --CONSTRAINT PK_occurs PRIMARY KEY (event_occurs, week_occurs) 
);
...
--Consulta 1: Obtener todos los eventos y sus detalles junto con los nombres de los módulos a los que están asociados.
...
--Consulta 5: Obtener el personal que enseña eventos de tipo "L" (lecciones) y la cantidad de eventos que enseñan
