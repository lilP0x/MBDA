...
ALTER TABLE VEHICULOS ADD CONSTRAINT check_a o_nacimiento CHECK (a_0 <= 1900);
...
-- Modificaci n de la tabla CONDUCTORES para agregar la restricci n de longitud de nombre
ALTER TABLE CONDUCTORES ADD CONSTRAINT restriccion_longitud_nombre CHECK (LENGTH(nombre) <= 50);

-- Restricci n para latitud y longitud en la tabla INICIAEN
...
-- Restricci n para latitud y longitud en la tabla FINALIZAEN
...
--Consulta para "Consultar viajes con requerimientos de m sica":
...
VALUES ('123456789', 'DN', '1234567890', 'Juan P rez', TO_DATE('2023-10-04', 'YYYY-MM-DD'), 1234567890, 'juan@example.com', 'ABCDE12345', TO_DATE('1990-01-15', 'YYYY-MM-DD'), 5, 'A');

INSERT INTO CONDUCTORES (id_conductor, tipo, numero, nombre, registro, celular, correo, licencia, fechaNacimiento, estrellas, estado)
VALUES ('987654321', 'CE', '9876543210', 'Mar a Gonz lez', TO_DATE('2023-10-04', 'YYYY-MM-DD'), 9876543210, 'maria@example.com', 'FGHIJ54321', TO_DATE('1985-05-20', 'YYYY-MM-DD'), 4, 'A');

INSERT INTO CONDUCTORES (id_conductor, tipo, numero, nombre, registro, celular, correo, licencia, fechaNacimiento, estrellas, estado)
VALUES ('567890123', 'PA', '5678901234', 'Pedro Ram rez', TO_DATE('2023-10-04', 'YYYY-MM-DD'), 5678901234, 'pedro@example.com', 'KLMNO67890', TO_DATE('1998-11-10', 'YYYY-MM-DD'), 3, 'A');
...
VALUES ('123456789', 'DI', '1234567890', 'Ana Garc a', TO_DATE('2023-10-04', 'YYYY-MM-DD'), 9876543210, 'ana@example.com', 'Espa ol');

INSERT INTO CLIENTES (id_cliente, tipo, numero, nombre, registro, celular, correo, idioma)
VALUES ('987654321', 'CD', '9876543210', 'Luis Rodr guez', TO_DATE('2023-10-04', 'YYYY-MM-DD'), 1234567890, 'luis@example.com', 'Ingl s');

INSERT INTO CLIENTES (id_cliente, tipo, numero, nombre, registro, celular, correo, idioma)
VALUES ('567890123', 'PS', '5678901234', 'Mar a L pez', TO_DATE('2023-10-04', 'YYYY-MM-DD'), 5555555555, 'maria@example.com', 'Franc s');
...
INSERT INTO SOLICITUDES (codigo, fechaCreacion, fechaViaje, plataforma, precio, estado, requerimientos, cliente, latitud, longitud, latitudFin, longitudFin)
VALUES (3, TO_DATE('2023-10-06', 'YYYY-MM-DD'), TO_DATE('2023-10-20', 'YYYY-MM-DD'), 'C', 3000, 'P', 'Asiani os', '567890123', 34.56789, -118.98765, 34.67890, -118.87654);
...
INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
VALUES ('TICKET002', TO_DATE('2023-10-05', 'YYYY-MM-DD'), TO_DATE('2023-10-10', 'YYYY-MM-DD'), 'Solicitud de informaci n', 'S', 'C', 2);

INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
VALUES ('TICKET003', TO_DATE('2023-10-06', 'YYYY-MM-DD'), NULL, 'Reporte de problema en la aplicaci n', 'P', 'A', 3);
...
INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
VALUES ('PQRS002', TO_DATE('2023-10-05', 'YYYY-MM-DD'), TO_DATE('2023-10-10', 'YYYY-MM-DD'), 'Solicitud de informaci n sobre un producto', 'S', 'C', 2);

INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
VALUES ('PQRS003', TO_DATE('2023-10-06', 'YYYY-MM-DD'), NULL, 'Reporte de problema en la aplicaci n m vil', 'P', 'A', 3);
...
--
INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
VALUES ('PQRS002',NULL, TO_DATE('2023-10-10', 'YYYY-MM-DD'), 'Solicitud de informaci n sobre un producto', 'S', 'C', 2);

--Escriban cinco casos de inserci n que no deber an permitirse y todav a se permiten.
--Documenten lo que desean validar. Traten de ilustrar lo m s significativo.

-- PoblarNoOK (2)       

--Restricci n: ALTER TABLE VEHICULOS ADD CONSTRAINT check_a o_nacimiento CHECK (a_0 <= 1900);
INSERT INTO VEHICULOS (placa, a_0, tipo, estado, puertas, pasajeros, carga, conductor)
VALUES ('ABC123', 2022, 'A', 'A', 4, 5, 1000, '123456789');

--Restricci n: ALTER TABLE VEHICULOS ADD CONSTRAINT restriccion_nombre CHECK (estado IN ('A', 'I', 'R', 'O'));
INSERT INTO VEHICULOS (placa, a_0, tipo, estado, puertas, pasajeros, carga, conductor)
VALUES ('XYZ789', 2019, 'B', 'X', 2, 2, 500, '123456789');

--Restricci n: ALTER TABLE VEHICULOS ADD CONSTRAINT check_puertas CHECK (puertas > 0);
INSERT INTO VEHICULOS (placa, a_0, tipo, estado, puertas, pasajeros, carga, conductor)
VALUES ('PQR456', 2021, 'C', 'A', 0, 7, 500, '987654321');

--Restricci n: ALTER TABLE VEHICULOS ADD CONSTRAINT check_pasajeros CHECK (pasajeros > 0);
INSERT INTO VEHICULOS (placa, a_0, tipo, estado, puertas, pasajeros, carga, conductor)
VALUES ('LMN789', 2020, 'D', 'A', 4, 0, 800, '567890123');

--Restricci n: ALTER TABLE VEHICULOS ADD CONSTRAINT check_carga CHECK (carga > 0);
INSERT INTO VEHICULOS (placa, a_0, tipo, estado, puertas, pasajeros, carga, conductor)
VALUES ('JKL456', 2022, 'E', 'A', 2, 2, -100, '234567890');

-- PoblarNoOK (2)

--Restriccion: Intento de insertar un conductor con un valor de 'tipo' no v lido:
...
--Restriccion:Intento de insertar un veh culo con un valor negativo para 'puertas':
...
--Restriccion: Intento de insertar una tarjeta con un n mero negativo:
...
INSERT INTO mbda.DATA (EMAIL, CEDULA, CELULAR, NOMBRES)VALUES ('juanito@escuelaing.edu.co', '1001192228','3005629947','juanito alimaña');

select * from mbda.DATA where CEDULA = '1001192228';

delete from mbda.DATA where CEDULA = '1001192228';
...
-- La fecha de viaje debe ser superior a la fecha de creaci n y a la fecha actual.
CREATE OR REPLACE TRIGGER TR_FECHA_CREACION
BEFORE INSERT ON SOLICITUDES 
FOR EACH ROW
BEGIN
    IF :NEW.fechaViaje < :NEW.fechaCreacion AND :NEW.fechaViaje < SYSTIMESTAMP THEN
        RAISE_APPLICATION_ERROR(-20101, 'La fecha de viaje debe ser superior a la fecha de creaci n y a la fecha actual.');
    END IF;
END;
...
CREATE OR REPLACE TRIGGER tipo_cc
...
CREATE OR REPLACE TRIGGER idioma_clientes_espanol
BEFORE INSERT ON CLIENTES
FOR EACH ROW
BEGIN
    :NEW.idioma := 'español';
...
CREATE OR REPLACE TRIGGER TR_CLIENTES_INS_CODIGO_FECHA
BEFORE INSERT ON CLIENTES
FOR EACH ROW
BEGIN
    :NEW.id_cliente := FLOOR(100000000+(999999999-100000000+1)*DBMS_RANDOM.VALUE);
...
DROP TRIGGER tipo_cc;
DROP TRIGGER idioma_cientes_español;
DROP TRIGGER TR_CLIENTES_INS_CODIGO_FECHA;
